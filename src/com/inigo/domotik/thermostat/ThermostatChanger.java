...
public class ThermostatChanger extends RESTServlet<Petition, ThermostatInfo> {
    ...
    public ThermostatChanger() {
        super(Petition.class, ThermostatInfo.class);
        tm = new ThermostatManager();
    }
	
	@Override
	protected ThermostatInfo doService(Petition reqObject, HttpServletRequest request, HttpServletResponse response) {
